...
# --- TAMBAHAN BARU: Import untuk semak enkripsi ---
...
def login():
    if request.method == 'POST':
        ...
        # --- UBAHAN: Gunakan check_password_hash untuk sahkan password ---
...
# --- TAMBAHAN BARU: Import untuk enkripsi ---
...
def register():
    if request.method == 'POST':
        ...
        # --- UBAHAN: Tukar password teks biasa kepada bentuk hashed/encrypted ---
        hashed_password = generate_password_hash(password, method='scrypt')

        # --- UBAHAN: Simpan hashed_password ke dalam database ---
